...
const int BUTTON_PICKER			= BIT(5);
const int BUTTON_ROTATE			= BIT(6);
...
const int IMPULSE_41			= 41;			//bc GET item.


const int IMPULSE_42			= 42;			//bc simulator noclip
const int IMPULSE_43			= 43;			//bc simulator exit
const int IMPULSE_44			= 44;			//bc simulator reset

const int IMPULSE_45			= 45;			//bc simulator insertion point.
const int IMPULSE_46			= 46;			//bc simulator extraction point.
