...
struct gameVersion_s {
	gameVersion_s( void ) { sprintf( string, "%s%s %s %s", ENGINE_VERSION,  BUILD_DEBUG, BUILD_STRING, __DATE__, __TIME__ ); }
	char	string[256];
} gameVersion;
...
// user info
idCVar ui_name(						"ui_name",					"Poncho",		CVAR_GAME | CVAR_USERINFO | CVAR_ARCHIVE, "player name" );
...
idCVar r_aspectRatio( 				"r_aspectRatio",			"4",			CVAR_RENDERER | CVAR_INTEGER | CVAR_ARCHIVE, "aspect ratio of view:\n0 = 4:3\n1 = 16:9\n2 = 16:10\n3 = 21:9\n4 = Auto", 0, 4 );
...
idCVar g_showEntityNames(			"g_showEntityNames",		"1",			CVAR_GAME | CVAR_BOOL, "" );
...
//bc
idCVar g_showModelNames(			"g_showmodelnames",			"0",			CVAR_GAME | CVAR_BOOL, "show model filenames" );
...
idCVar g_slowmoStepRate(			"g_slowmoStepRate",			"0.1",			CVAR_GAME | CVAR_FLOAT, "" );
...
idCVar g_vehicleVelocity(			"g_vehicleVelocity",		"400",			CVAR_GAME | CVAR_FLOAT, "" );
idCVar g_vehicleForce(				"g_vehicleForce",			"40000",		CVAR_GAME | CVAR_FLOAT, "" );
...
idCVar g_vehicleTireFriction(		"g_vehicleTireFriction",	"0.4",			CVAR_GAME | CVAR_FLOAT, "" );
#ifdef _D3XP

//bc
idCVar g_vehicleDebug(				"g_vehicleDebug",			"0",			CVAR_GAME | CVAR_BOOL, "" );
idCVar g_vehicleControlType(		"g_vehicleControlType",		"1",			CVAR_GAME | CVAR_INTEGER | CVAR_ARCHIVE, "0 = mouselook\n1 = direct control" );
idCVar g_demotimeout(				"g_demotimeout",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "How many minutes before demo restarts." );
idCVar g_demo(						"g_demo",					"0",			CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "Demo mode. Restarts game after X minutes of inactivity." );
idCVar g_commentary(				"g_commentary",				"0",			CVAR_GAME | CVAR_BOOL, "Show commentary bubbles." );

#ifdef STEAM
idCVar steam_cloudsave(				"steam_cloudsave",			"0",			CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "Enable steam cloud for savegames." );
#endif

idCVar g_leveldone_0(				"g_leveldone_0",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_1(				"g_leveldone_1",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_2(				"g_leveldone_2",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_3(				"g_leveldone_3",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_4(				"g_leveldone_4",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_5(				"g_leveldone_5",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_6(				"g_leveldone_6",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_7(				"g_leveldone_7",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_8(				"g_leveldone_8",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_9(				"g_leveldone_9",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_10(				"g_leveldone_10",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_11(				"g_leveldone_11",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_12(				"g_leveldone_12",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_13(				"g_leveldone_13",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_14(				"g_leveldone_14",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_15(				"g_leveldone_15",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_16(				"g_leveldone_16",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_17(				"g_leveldone_17",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_18(				"g_leveldone_18",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_19(				"g_leveldone_19",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_20(				"g_leveldone_20",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_21(				"g_leveldone_21",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_22(				"g_leveldone_22",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_23(				"g_leveldone_23",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_24(				"g_leveldone_24",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_25(				"g_leveldone_25",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_26(				"g_leveldone_26",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_27(				"g_leveldone_27",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_28(				"g_leveldone_28",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_29(				"g_leveldone_29",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_30(				"g_leveldone_30",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );
idCVar g_leveldone_31(				"g_leveldone_31",			"0",			CVAR_GAME | CVAR_BOOL |  CVAR_ARCHIVE, "Level completion cvar." );




idCVar g_own_flotilla(				"g_own_flotilla",			"0",			CVAR_GAME | CVAR_BOOL, "" );
idCVar g_own_airforte(				"g_own_airforte",			"0",			CVAR_GAME | CVAR_BOOL, "" );
idCVar g_own_azs(					"g_own_azs",				"0",			CVAR_GAME | CVAR_BOOL, "" );
idCVar g_own_tfol(					"g_own_tfol",				"0",			CVAR_GAME | CVAR_BOOL, "" );

idCVar g_launchermultiplier(		"g_launchermultiplier",		"1.45",			CVAR_GAME | CVAR_FLOAT, "" );
...
idCVar pm_ladderbob(				"pm_ladderbob",				"0.4",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "bob much faster when on ladder" );
...
idCVar pm_thirdPersonRange(			"pm_thirdPersonRange",		"300",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "camera distance from player in 3rd person" );
...
idCVar pm_airTics(					"pm_air",					"10000",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_INTEGER, "how long in milliseconds the player can go without air before he starts taking damage" );

idCVar pm_airVacuumRate(			"pm_airVacuumRate",			"20",			CVAR_GAME | CVAR_INTEGER, "multiplier for how long the player can last in vacuum. Bigger number = shorter time in vacuum." );
...
idCVar g_grabberEnableShake(		"g_grabberEnableShake",		"0",			CVAR_GAME | CVAR_BOOL | CVAR_CHEAT, "enable the grabber shake" );
idCVar g_grabberRandomMotion(		"g_grabberRandomMotion",	"0",			CVAR_GAME | CVAR_BOOL | CVAR_CHEAT, "enable random motion on the grabbed object" );
