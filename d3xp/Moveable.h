...
protected:
	...
	//make sound when player pushes the thing.
	int						nextPushTime;			// next time the moveable can make a sound
	...
	//bc
	void					Event_GetOriginalPosition( void );
	void					Event_GetOriginalAngle( void );
};
