...
extern const idEventDef EV_Thread_lerp;
...
extern const idEventDef EV_Thread_deck_split;
extern const idEventDef EV_Thread_deck_split2;
extern const idEventDef EV_Thread_deck_getArg;
extern const idEventDef EV_Thread_deck_hasArg;
extern const idEventDef EV_callMap;
extern const idEventDef EV_getMapname;
extern const idEventDef EV_getworldspawnint;
extern const idEventDef EV_Thread_SpawnDecal;
extern const idEventDef EV_Thread_killcctvs;
//extern const idEventDef EV_setcutscene;

extern const idEventDef EV_getMapIndex;

extern const idEventDef EV_callsavegame;
...
private:
	...
	void						Event_deck_split( float index, const char* text);
	void						Event_deck_split2( float index, const char* text, const char* divider);
	void						Event_deck_split3( float index, const char* text, const char* divider);
	void						Event_deck_getArg( const char *text );
	void						Event_deck_hasArg( const char *text, const char *functionName );
	void						Event_getMapname( void );
	void						Event_killcctvs();

	void						Event_getMapIndex( void );
	...
	const char *				Event_parseTimeMS( int value );
	void						Event_getString( const char *value );

	//void						Event_SteamAddStat( const char *statname, int value );
	void						Event_SteamAddTimeStat( int value, int missionIndex );
	void						Event_SteamGetGlobalStat( const char *statname );
	void						Event_SteamUpdateFriendTimes( int missionIndex );
	bool						Event_SteamSetAchievement( const char *achievementName );
...
public:							
	...
	//bc
	void						Event_callMap( const char *text );
	void						Event_getworldspawnint( const char *keyname );
	void						Event_setcutscene( int value );
	void						Event_SpawnDecal( idVec3 const &pos, idVec3 const &endpos, float size, const char* material );
	void						Event_callsavegame( int savetype );
