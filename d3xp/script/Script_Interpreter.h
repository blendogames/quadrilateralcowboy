...
#define LOCALSTACK_SIZE 	49152 //bc 6144
...
ID_INLINE void idInterpreter::PopParms( int numParms ) {
	...
	if ( localstackUsed < numParms ) {
		//BC TODO: figure out why passing args from code->script causes this error.
		//Error( "locals stack underflow\n" );
		//gameLocal.Printf("locals stack underflow. localstackUsed: %d numParms: %d\n", localstackUsed, numParms);
	}
