...
idCVar r_fullscreenDesktop( "r_fullscreenDesktop", "0", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_BOOL, "1: 'real' fullscreen mode 1: keep resolution 'desktop' fullscreen mode" );
